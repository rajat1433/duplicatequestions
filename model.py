...
KERAS_DATASETS_DIR = ('E:\Anaconda64\Lib\site-packages\keras\datasets\\')
MY_DATASETS_DIR = ('D:\India Hacks 2017\\')
QUESTION_PAIRS_FILE_URL = 'http://qim.ec.quoracdn.net/quora_duplicate_questions.tsv'
QUESTION_PAIRS_FILE = 'quora_duplicate_questions.tsv'
QUESION_PAIRS_FILE = 'check.tsv' 
...
result = model.predict([Q1_test, Q2_test] , verbose=0)

result = (result > 0.5)

from sklearn.metrics import confusion_matrix
cm1 = confusion_matrix(y_test,result)
a1=(cm1[0,0]+cm1[1,1])/(cm1[0,0]+cm1[1,1]+cm1[1,0]+cm1[0,1])
p1=cm1[0,0]/(cm1[0,0]+cm1[0,1])
r1=cm1[0,0]/(cm1[0,0]+cm1[1,0])
f1=(2*p1*r1)/(p1+r1)